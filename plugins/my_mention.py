...
def help_func(message):
    ...
    if help_count < 2:
        message.send('''〜使い方〜\n
                    start : スケジュール調整を開始します\n
                            $ユーザー名 または GoogleカレンダーのURLを入力することで予定を取り込みます (例)$kyoko\n
                    set 20180701-20180731 : スケジュール対象範囲を 2018/7/1 ~ 2018/7/31 に設定します\n
                    settime 08-22 : 対象時間を 8時〜22時 に設定します\n
                    reg $(ユーザー名) [Googleカレンダーの非公開URL] ： ユーザー名にURLを登録します，登録するとユーザー名で予定を取り込めるようになります．\n
